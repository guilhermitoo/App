        ...
        $(document).ready(function(){
                    ...
                    url: "../backEnd/buscaChamados.php?tipo=A", method: "get", dataType: "json", success: function(data) {                
                        ...
                        for($i=0; $i < data.length; $i++){
                                html += "<tr>  " +
                                        ...
                                        "<td width='40%'>" + data[$i].descricao + " </td> " +
                                        ...
                                        "<td class='text-justify' width='100p'>"+
            ...
            function Realizar(){
                ...
                if(confirm("Deseja realmente realizar o chamado " + id + "?")){
                    fechaChamado(id,'R'); // fecharChamado retorna o texto se deu certo ou não.
                }
            }
            ...
            function Cancelar(){
                ...
                if(confirm("Deseja realmente cancelar o chamado " + id + "?")){
                    fechaChamado(id,'C'); // fecharChamado retorna o texto se deu certo ou não.
                }
            }
            ...
            function fechaChamado(id,tipo){
                ...
                $.ajax({
                        url: "../backEnd/fechaChamado.php", method: "POST", data: dados, success : function(data) {
                            alert(data);
                            carregaLista();
                        }
                });            
